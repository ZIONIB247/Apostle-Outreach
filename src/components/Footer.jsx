      ...
      <div className="genLayout">
        <div className="footGrid">
          <div className="footCard">
            ...
            <div className="footerIcon">
              <span>
                <TiSocialFacebook style={{ fontSize: "20px", color: "white" }} />
              </span>
              <span>
        ...
        <div className="bottomFoot">
            <div className="buttomCont">
                <p>Apostle Chidi Alagwu Outreach is a nonprofit 501(c)(3) organization; EIN/Tax ID number: <span>13-2725416</span>  | DUNS number: 07-520-9411

© 2024 Apostle Chidi Alagwu Outreach. All rights reserved.  <span>Privacy Policy</span> </p>
            </div>
